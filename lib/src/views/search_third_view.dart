...
class SearchInfoViewState extends ConsumerState<SearchInfoView> {
  ...
  Widget build(BuildContext context) {
    final songTotalInfo = ref.watch(songTotalInfoProvider);
    final textStyle = Theme.of(context).textTheme;
    return songTotalInfo != null
        ? Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  _InfoRow(
                    textLabel: 'Album',
                    textInfo: songTotalInfo.albumName,
                    textStyle: textStyle,
                  ),
                  const SizedBox(height: 2),
                  // * Artist
                  _InfoRow(
                    textLabel: 'Artist',
                    textInfo: songTotalInfo.artistName,
                    textStyle: textStyle,
                  ),
                  const SizedBox(height: 2),
                  // * Realease Date
                  _InfoRow(
                    ...
                    textInfo: songTotalInfo.releaseDate,
                    textStyle: textStyle,
                  ),
                  const SizedBox(height: 2),
                  //* Lyrics
        ...
        : const Text('No se a seleccionado canción');
  }
}
