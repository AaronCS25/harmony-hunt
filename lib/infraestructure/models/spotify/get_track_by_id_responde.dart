class TrackByIdResponse {
  ...
  factory TrackByIdResponse.fromJson(Map<String, dynamic> json) =>
      TrackByIdResponse(
...
class TrackAlbum {
  ...
  factory TrackAlbum.fromJson(Map<String, dynamic> json) {
    // TODO: FIX IT (releaseDate)
    String releaseDateString = json["release_date"];
    DateTime parsedReleaseDate;

    // Verifica si la cadena de fecha es solo un año (4 caracteres)
    if (releaseDateString.length == 4) {
      // Construye una fecha con el año y valores predeterminados para mes y día
      parsedReleaseDate = DateTime(int.parse(releaseDateString), 1, 1);
    } else {
      // Parsea la fecha completa
    ...
    return TrackAlbum(
      ...
      href: json["href"],
      id: json["id"],
      images: List<TrackImage>.from(
          json["images"].map((x) => TrackImage.fromJson(x))),
      name: json["name"],
...
class TrackExternalUrls {
  ...
  factory TrackExternalUrls.fromJson(Map<String, dynamic> json) =>
      TrackExternalUrls(
...
class TrackExternalIds {
  ...
  factory TrackExternalIds.fromJson(Map<String, dynamic> json) =>
      TrackExternalIds(
        isrc: json["isrc"],
      );
